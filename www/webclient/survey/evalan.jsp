...
if (action !=null && action.equals("export"))
	...
	//response.sendRedirect(""+aweval.createExport(getServletContext().getRealPath("/"),uid,extitle));
	}	
...
<jsp:include page="/webclient/survey/resource/fieraheader.jsp" flush="true"/>
	<table width="100%" border=1>
		...
		String checkItems ="select item, itemshortname from survey_itemid where itemid= '"+itemid+"'";
	    ...
	    "tq1 as (select aid, count(*) cnt  from aweval.eval_responses_static  where rid in (select rid from survey_submission where itemid in (select itemid from survey_itemid where "+uidClause+") and "+tsPeriod+" and "+itemidClause+")group by aid), " +
	    "tq2 as " +
	    ...
	    title = evalPeriod +" - Evaluation Results for "+item; //rs1.getString("item");
		%>
			    <TABLE BORDER=0 width=100%>
						...
						<td align="center" width="100%">
							<table border="0" cellspacing="0" cellpadding="0" width="100%">
							    <tr>
							    	<td align="center" width="100%">
							   			<%
							    		aweval.navTable(out,yearParam,navMonth,itemid,"./evalan.jsp",uidClause);
							    		%>
							    	</td>
							    	<td>
							    		<table>
											...
											<tr>
												<td>
													<FORM name=list action="./evalan.jsp"  method="GET">
										  			...
										  			<table border="1" cellpadding="0" cellspacing="0" width="100%">
														...
														for (int i = 1; i <= colCount; i ++)
															...
															if (rs1md.getColumnName(i).toLowerCase().equals("details"))
																{
																	dispValue = "&nbsp;&nbsp;&nbsp;<a href=\"./rollup.jsp?itemid="+ itemid +"&year="+yearParam+"&month="+monthParam+"&qid="+rs1.getString("details")+"\">See&nbsp;responses</a>&nbsp;"; 
																}
															else
															{
					...
					<tr>
						<td align="right">
							Right click to save <a href="./evalan.jsp?action=export&extitle=<%= title %>">Export Data</a>									
						</td>						
					</tr>				    	
			    </table>
