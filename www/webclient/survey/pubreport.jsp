	...
	<table width="100%" border=1>
		<tr>
			<td align="center" valign="top">
				...
				String [] col = {"itemshortname","owner","item","cnt"};
				String [] ord = {"asc","asc","asc","desc"};
				...
				String title = evalPeriod +" Public&nbsp;Report:&nbsp;Totals&nbsp;for&nbsp;"+item;
				...
				<TABLE cellpadding="0" cellspacing="0">
				  			...
				  			<table>
				  				<tr>
							    	...
							    	<td align="center" width="100%">
							   			<%
							    		aweval.navTable(out,yearParam,navMonth,itemid,"./pubreport.jsp",uidClause);
							    		%>
							    	</td>
							  	</tr>
						...
						<td  valign="top">
							...
							%>
								...
								int colCount = rsmd.getColumnCount();
									...
									{
										out.println("<th><a href=\"./pubreport.jsp?col="+i+"&year="+ yearParam +"&month="+ monthParam +"&itemid="+ itemid +"\">"+rsmd.getColumnName(i)+"</a></th>");
									}
								%>
								</tr>
								<%
					...
					<tr>
						<td>
							...
							Page:
							<%
								aweval.pageCount(out, "./pubreport.jsp?col="+(colNum+1)+"&year="+ yearParam +"&month="+ monthParam +"&itemid="+ itemid +"&ipos=", ipos, icnt, pageCnt, itemPageSize);
							%>
									</td>
								</tr>
							</table>
