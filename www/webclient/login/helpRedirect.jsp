<%@ page contentType="text/html;charset=UTF-8" import= "psdi.servlet.*;" %>
<%
	/* This jsp is identical to the servlet in the maximohelp EAR (placed here
	   for convenient reference from Maximo app context.) */
    String path = "";
    String host = "";
    String port = "";
