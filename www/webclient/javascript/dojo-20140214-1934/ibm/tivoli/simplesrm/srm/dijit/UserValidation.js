...
define("ibm/tivoli/simplesrm/srm/dijit/UserValidation", ["dijit","dojo","dojox","dojo/require!dijit/_Widget,dijit/_Templated,dojo/parser,dijit/form/Button,ibm/tivoli/tpae/dojo/data/tpaeQuery,ibm/tivoli/simplesrm/srm/dijit/WidgetBase,ibm/tivoli/simplesrm/srm/dijit/ProgressSpinner"], function(dijit,dojo,dojox){
//////////////////////////////////////////////////////////////////
...
dojo.declare("ibm.tivoli.simplesrm.srm.dijit.UserValidator", null,
{
	...
	_onLogin: function(response, ioArgs)
	{
		if(response.documentElement.tagName.match(/error/i)) {
			...
			ibm.tivoli.tpae.data.loggedInUsername = this.username;
