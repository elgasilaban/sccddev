...
define("ibm/tivoli/simplesrm/srm/dijit/request/GenericForm", ["dijit","dojo","dojox","dojo/require!ibm/tivoli/simplesrm/srm/dijit/CreateCatalogRequest,dojo/parser,ibm/tivoli/tip/dijit/TextInputBox,dijit/form/ValidationTextBox,ibm/tivoli/tip/dijit/TextArea,ibm/tivoli/tip/dijit/NumberInputBox"], function(dijit,dojo,dojox){
//////////////////////////////////////////////////////////////////
	...
	_genForm: function(attributes)
	{
		try {
			...
			f += "<tr><td><label for='"+this.id+"_Description' class='required'>Description</label></td><td>"
			  ...
			  + "<tr><td><label for='"+this.id+"_requestedfor' class='required'>${_uiStringTable.RequestedFor}</label></td><td>"+this._genInputElement({AssetAttrID: "requestedfor", Mandatory: "true", DataType: this.ALN, ALNValue: ibm.tivoli.tpae.data.loggedInUsername})+"</td></tr>\n";
