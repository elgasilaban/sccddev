...
define("ibm/tivoli/simplesrm/srm/dijit/Overview/ApprovalsPod", ["dijit","dojo","dojox","dojo/require!ibm/tivoli/simplesrm/srm/dijit/Overview/Pod,ibm/tivoli/simplesrm/srm/dijit/Overview/RequestDetails,ibm/tivoli/simplesrm/srm/dojo/data/srmQuery,ibm/tivoli/simplesrm/srm/dijit/MyCatalogRequestsGrid"], function(dijit,dojo,dojox){
//////////////////////////////////////////////////////////////////
...
dojo.declare("ibm.tivoli.simplesrm.srm.dijit.Overview.ApprovalsPod", ibm.tivoli.simplesrm.srm.dijit.Overview.Pod,
{
	...
	_updateData: function(response)
	{
		try {
			...
			ibm.tivoli.logger.error("ApprovalsPod._updateData failure",ex);
		}
		finally {
			this._resetPoll();
		}
...
dojo.declare("ibm.tivoli.simplesrm.srm.dijit.Overview.ApprovalDetails", ibm.tivoli.simplesrm.srm.dijit.Overview.Details,
{
	...
	constructor: function()
	{
		this.headingText = dojo.i18n.getLocalization("ibm.tivoli.simplesrm.srm.dijit", "uiStringTable").ManageApprovals;
	},
