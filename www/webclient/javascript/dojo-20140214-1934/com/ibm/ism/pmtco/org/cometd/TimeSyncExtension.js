...
define("com/ibm/ism/pmtco/org/cometd/TimeSyncExtension", ["dijit","dojo","dojox"], function(dijit,dojo,dojox){
/*
...
{
    dojo.provide("com.ibm.ism.pmtco.org.cometd.TimeSyncExtension");
}
...
com.ibm.ism.pmtco.org.cometd.TimeSyncExtension = function(configuration)
{
    var _cometd;
    ...
    this.outgoing = function(message)
    {
        ...
        if (channel && channel.indexOf('/meta/') === 0)
        {
            ...
            _debug('TimeSyncExtension: client sending timesync', com.ibm.ism.pmtco.org.cometd.JSON.toJSON(message.ext.timesync));
        }
        return message;
    };
    ...
    this.setTimeout = function(callback, atServerTimeOrDate)
    {
        ...
        return com.ibm.ism.pmtco.org.cometd.Utils.setTimeout(_cometd, callback, interval);
    };
};
