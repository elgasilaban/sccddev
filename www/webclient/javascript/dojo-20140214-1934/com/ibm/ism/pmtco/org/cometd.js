...
define("com/ibm/ism/pmtco/org/cometd", ["dijit","dojo","dojox"], function(dijit,dojo,dojox){
/*
...
{
    dojo.provide('com.ibm.ism.pmtco.org.cometd');
}
else
{
    // Namespaces for the cometd implementation
    this.org = this.org || {};
    com.ibm.ism.pmtco.org.cometd = {};
}

com.ibm.ism.pmtco.org.cometd.JSON = {};
com.ibm.ism.pmtco.org.cometd.JSON.toJSON = com.ibm.ism.pmtco.org.cometd.JSON.fromJSON = function(object)
{
    throw 'Abstract';
};

com.ibm.ism.pmtco.org.cometd.Utils = {};

com.ibm.ism.pmtco.org.cometd.Utils.isString = function(value)
{
...
com.ibm.ism.pmtco.org.cometd.Utils.isArray = function(value)
{
    if (value === undefined || value === null)
    {
        return false;
 ...
 */
com.ibm.ism.pmtco.org.cometd.Utils.inArray = function(element, array)
{
...
com.ibm.ism.pmtco.org.cometd.Utils.setTimeout = function(cometd, funktion, delay)
{
...
com.ibm.ism.pmtco.org.cometd.Utils.clearTimeout = function(timeoutHandle)
{
 ...
 */
com.ibm.ism.pmtco.org.cometd.TransportRegistry = function()
{
    var _types = [];
    var _transports = {};
 ...
 */
com.ibm.ism.pmtco.org.cometd.Transport = function()
{
    var _type;
    var _cometd;
    ...
    {
        return com.ibm.ism.pmtco.org.cometd.Utils.setTimeout(_cometd, funktion, delay);
    };

    this.clearTimeout = function(handle)
    {
        com.ibm.ism.pmtco.org.cometd.Utils.clearTimeout(handle);
    };
    ...
    {
        if (com.ibm.ism.pmtco.org.cometd.Utils.isString(response))
        {
            try
            {
                return com.ibm.ism.pmtco.org.cometd.JSON.fromJSON(response);
            }
            catch(x)
            {
        ...
        if (com.ibm.ism.pmtco.org.cometd.Utils.isArray(response))
        {
            return response;
        }
...
com.ibm.ism.pmtco.org.cometd.Transport.derive = function(baseObject)
{
    function F() {}
 ...
 */
com.ibm.ism.pmtco.org.cometd.RequestTransport = function()
{
    var _super = new com.ibm.ism.pmtco.org.cometd.Transport();
    var _self = com.ibm.ism.pmtco.org.cometd.Transport.derive(_super);
    var _requestIds = 0;
    ...
    {
        var index = com.ibm.ism.pmtco.org.cometd.Utils.inArray(request, _requests);
...
com.ibm.ism.pmtco.org.cometd.LongPollingTransport = function()
{
    var _super = new com.ibm.ism.pmtco.org.cometd.RequestTransport();
    var _self = com.ibm.ism.pmtco.org.cometd.Transport.derive(_super);
    ...
    _self.transportSend = function(envelope, request)
    {
        ...
        try
        {
            ...
            request.xhr = this.xhrSend({
                ...
                body: com.ibm.ism.pmtco.org.cometd.JSON.toJSON(envelope.messages),
...
com.ibm.ism.pmtco.org.cometd.CallbackPollingTransport = function()
{
    var _super = new com.ibm.ism.pmtco.org.cometd.RequestTransport();
    var _self = com.ibm.ism.pmtco.org.cometd.Transport.derive(_super);
    var _maxLength = 2000;
    ...
    _self.transportSend = function(envelope, request)
    {
        ...
        while (length > 0)
        {
            ...
            var json = com.ibm.ism.pmtco.org.cometd.JSON.toJSON(envelope.messages.slice(start, start + length));
        ...
        try
        {
            ...
            this.jsonpSend({
                ...
                headers: this.getConfiguration().requestHeaders,
                body: com.ibm.ism.pmtco.org.cometd.JSON.toJSON(envelopeToSend.messages),
...
com.ibm.ism.pmtco.org.cometd.WebSocketTransport = function()
{
    var _super = new com.ibm.ism.pmtco.org.cometd.Transport();
    var _self = com.ibm.ism.pmtco.org.cometd.Transport.derive(_super);
    var _cometd;
    ...
    function _websocketConnect()
    {
        ...
        var webSocket = new com.ibm.ism.pmtco.org.cometd.WebSocket(url);
        var self = this;
    ...
    {
        var json = com.ibm.ism.pmtco.org.cometd.JSON.toJSON(envelope.messages);
    ...
    _self.onMessage = function(wsMessage)
    {
        ...
        for (var j = 0; j < messageIds.length; ++j)
        {
            ...
            {
                var ids = key.split(',');
                var index = com.ibm.ism.pmtco.org.cometd.Utils.inArray(id, ids);
                if (index >= 0)
                {
                    removed = true;
                    ids.splice(index, 1);
    ...
    _self.accept = function(version, crossDomain, url)
    {
        ...
        return _supportsWebSocket && !!com.ibm.ism.pmtco.org.cometd.WebSocket && _cometd.websocketEnabled !== false;
    };
...
com.ibm.ism.pmtco.org.cometd.Cometd = function(name)
{
    var _cometd = this;
    var _name = name || 'default';
    var _crossDomain = false;
    var _transports = new com.ibm.ism.pmtco.org.cometd.TransportRegistry();
    var _transport;
    ...
    {
        return com.ibm.ism.pmtco.org.cometd.Utils.isString(value);
    }
    ...
    function _cancelDelayedSend()
    {
        ...
        {
            com.ibm.ism.pmtco.org.cometd.Utils.clearTimeout(_scheduledSend);
        }
        _scheduledSend = null;
    }
    ...
    function _delayedSend(operation)
    {
        ...
        _scheduledSend = com.ibm.ism.pmtco.org.cometd.Utils.setTimeout(_cometd, operation, delay);
    }
    ...
    {
        if (!com.ibm.ism.pmtco.org.cometd.Utils.isArray(subscription))
        {
    ...
    com.ibm.ism.pmtco.org.cometd.WebSocket = window.WebSocket;
    if (!com.ibm.ism.pmtco.org.cometd.WebSocket)
    {
        com.ibm.ism.pmtco.org.cometd.WebSocket = window.MozWebSocket;
    }
};
