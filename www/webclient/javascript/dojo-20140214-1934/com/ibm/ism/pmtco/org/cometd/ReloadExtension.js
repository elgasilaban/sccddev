...
define("com/ibm/ism/pmtco/org/cometd/ReloadExtension", ["dijit","dojo","dojox"], function(dijit,dojo,dojox){
/*
...
{
    dojo.provide('com.ibm.ism.pmtco.org.cometd.ReloadExtension');
}

if (!com.ibm.ism.pmtco.org.cometd.COOKIE)
{
    com.ibm.ism.pmtco.org.cometd.COOKIE = {};
    com.ibm.ism.pmtco.org.cometd.COOKIE.set = function(name, value, options)
    {
        throw 'Abstract';
    };
    com.ibm.ism.pmtco.org.cometd.COOKIE.get = function(name)
    {
        throw 'Abstract';
    };
}
 ...
 */
com.ibm.ism.pmtco.org.cometd.ReloadExtension = function(configuration)
{
    var _cometd;
    var _debug;
    var _state = null;
    var _cookieName = 'com.ibm.ism.pmtco.org.cometd.reload';
    var _cookiePath = '/';
    var _cookieMaxAge = 5;
    var _batch = false;
    ...
    function _reload(config)
    {
        if (_state && _state.handshakeResponse !== null)
        {
            ...
            var cookie = com.ibm.ism.pmtco.org.cometd.JSON.toJSON(_state);
            _debug('Reload extension saving cookie value', cookie);
            com.ibm.ism.pmtco.org.cometd.COOKIE.set(_cookieName, cookie, {
    ...
    this.outgoing = function(message)
    {
        ...
        if (channel == '/meta/handshake')
        {
            ...
            var cookie = com.ibm.ism.pmtco.org.cometd.COOKIE.get(_cookieName);
            ...
            if (cookie)
            {
                try
                {
                    ...
                    com.ibm.ism.pmtco.org.cometd.COOKIE.set(_cookieName, '', {
                        path: _cookiePath
                    });

                    var oldState = com.ibm.ism.pmtco.org.cometd.JSON.fromJSON(cookie);
